...
.title-area { text-align: center; padding: 1.4rem 0 0.8rem 0; }
...
.answer-card {
    ...
    padding: 1.8rem 2rem; font-size: 1.45rem; line-height: 2.0; color: #222;
...
.stButton > button {
    ...
    padding: 0.85rem 1.4rem !important; border-radius: 16px !important;
    border: none !important; width: 100% !important; min-height: 3.8rem !important;
}
...
""",
    ...
    with col_a:
        st.caption(f"내 연결 코드: {parent_code}")
    with col_b:
        if st.button("로그아웃"):
            logout()
